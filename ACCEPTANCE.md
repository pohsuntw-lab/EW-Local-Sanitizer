...
- C1: Synthetic standard/RSA/EC/DSA/OpenSSH/encrypted/PGP private-key blocks, OpenAI-style tokens, GitHub tokens, passwords and connection strings—including single-line quoted key/value assignments—are critical findings; mismatched key armor is not consumed as one block.
