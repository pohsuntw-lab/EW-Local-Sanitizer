...
- D5: Keeping a high-risk non-credential finding requires a written reason and records residual risk.
...
- F6: EW Enterprise Secure Knowledge Forge can validate the manifest schema and processing route.
