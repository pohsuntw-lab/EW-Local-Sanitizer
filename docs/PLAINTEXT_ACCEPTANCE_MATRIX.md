...
| F1–F5, F7–F16 verified export, complete P0–P3 route matrix, schema/semantic validation, allowlist, ZIP inspection and hashes | `verification-package.test.ts` single- and multi-source end-to-end cases | Pass for the repository v0.1 schema and plain-text item model |
